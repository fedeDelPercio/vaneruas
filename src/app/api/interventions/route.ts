...
// Categoría que NO entra a la bandeja: `validacion_pago`. Es la ÚNICA
// derivación que genera un comprobante: el worker procesa el comprobante fuera
// del orquestador (ver src/app/api/jobs/process) y solo registra esa
// notificación. Por eso excluirla equivale exactamente a "no mostrar las
// derivadas por comprobante", que ya viven en /payments. El resto de las
// categorías (cliente_existente, interes_compra, fuera_de_conocimiento,
// escalado_manual, falla_tecnica) SÍ necesitan la atención del equipo acá
// (esta clienta va a tener muchas clientas existentes, y queremos verlas).
const EXCLUDED_CATEGORIES = ["validacion_pago"];
